...
It's important to test AI generated code to ensure that it's working as expected, _before_ you deploy it to production. CodeWP ships with built in testing tools for Pro users. In this guide, we'll show you how to use them, and cover general testing best practices.
...
If you're using a plugin-specific mode, the relevant plugin will be installed and activated as well.
...
**While these pro testing features are helpful, they don't replace the need to test on a staging site, as this will help catch any plugin/enviorment specific conflicts.**

## However, these tools provide a good 'first look' at the code.
